    ...
    <>
      ...
      <main className="inner-page">
        ...
        <section className="section project-gallery">
          ...
          <Gallery
            images={[
              { id: p.image, label: "Архитектура и фасад" },
              {
                id: [12998902, 7546713, 7166931][index % 3],
                label: "Интерьер и отделка",
              },
              {
                id: [7166931, 12998902, 7546713][index % 3],
                label: "Материалы и детали",
              },
              { id: 5563466, label: "Терраса и пергола" },
              { id: 35070095, label: "Озеленение и пространство для отдыха" },
            ]}
          />
